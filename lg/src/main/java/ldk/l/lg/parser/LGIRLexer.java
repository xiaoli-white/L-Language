...
public class LGIRLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__33", "T__34", "NUMBER", "WS", "SHARP", "PERCENT", "COMMA", "COLON", 
			"SEMICOLON", "OPEN_PAREN", "CLOSE_PAREN", "OPEN_BRACKET", "CLOSE_BRACKET", 
			"OPEN_BRACE", "CLOSE_BRACE", "ADD", "SUB", "MUL", "DIV", "MOD", "AND", 
			"OR", "XOR", "SHL", "SHR", "USHR", "NEG", "NOT", "ZEXT", "SEXT", "TRUNC", 
			"ITOF", "FTOI", "FEXT", "FTRUNC", "VOID", "U1", "U8", "U16", "U32", "U64", 
			"I1", "I8", "I16", "I32", "I64", "FLOAT", "DOUBLE", "STRING_LITERAL", 
			"IDENTIFIER"
		};
	}
	...
	public LGIRLexer(CharStream input) {
		super(input);
