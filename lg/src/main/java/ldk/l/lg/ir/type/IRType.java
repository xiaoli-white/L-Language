...
public abstract sealed class IRType extends IRNode permits IRArrayType, IRDoubleType, IRFloatType, IRFunctionReferenceType, IRIntegerType, IRPointerType, IRStructureType, IRVoidType {
    @Override
